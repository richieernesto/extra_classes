  ...
  var _displaySnackBar = false;
   ...
   Future <void> _submit() async {
    ...
    if (_authMode == AuthMode.SignIn) {
      ...
      await Provider.of<Auth>(context, listen: false).signUp(mail!, pass!, );
          ...
          child: Column(children: <Widget>[
            ...
            _authMode == AuthMode.SignUp
                ...
                _isLoading? Padding(
                  ...
                  child: SpinKitDualRing(color: Colors.blue, size: 30,),
                ):
            ElevatedButton(onPressed: _submit, child: Text(_authMode == AuthMode.SignIn?  "Sign In": "Sign Up")),
            Row(
            mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                GestureDetector(
                  onTap: _setAuthMode,
                  child: Text(_authMode==AuthMode.SignIn? "Sign up Instead": "Sign In",
                      style: TextStyle(
                        color: Colors.red,
                      )),
